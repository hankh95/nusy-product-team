...
### New Files
- `santiago_core/services/knowledge_graph.py` - Complete RDF knowledge graph implementation

### Modified Files
- `santiago_core/core/team_coordinator.py` - Added knowledge graph initialization
- `santiago_core/agents/santiago_pm.py` - Integrated knowledge graph for task tracking
- `santiago_core/agents/santiago_architect.py` - Added learning and persistence
- `santiago_core/agents/santiago_developer.py` - Task recording and experience logging
