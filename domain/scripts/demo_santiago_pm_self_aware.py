...
def load_santiago_pm_manifest():
    ...
    if not manifest_path.exists():
        print(f"❌ Santiago-PM manifest not found at {manifest_path}")
...
def demonstrate_self_awareness():
    """Main demo function."""
    print("=" * 80)
    print("🧠 SANTIAGO SELF-AWARE DEMO")
    print("=" * 80)
    print()
    ...
    print("📍 Step 1: Load Santiago-PM MCP Manifest")
    print("-" * 80)
    ...
    print(f"✅ Loaded manifest: {manifest['service_name']}")
    ...
    # Show tools
    print("🔧 Available PM Tools:")
    for tool in manifest['tools']:
        tool_type_icon = "📥" if tool['tool_type'] == "input" else "📤"
        mutates_icon = "✏️" if tool.get('mutates_kg', False) else ""
        concurrent_icon = "⚠️" if tool.get('concurrency_risk', False) else ""
        
        print(f"   {tool_type_icon} {tool['name']:30s} {mutates_icon}{concurrent_icon}")
    print()
    
    # Step 2: Load Knowledge Graph
    print("📍 Step 2: Load Santiago's Knowledge Graph")
    print("-" * 80)
    kg = KGStore(workspace_path=".")
    stats = kg.get_statistics()
    
    print(f"✅ Loaded KG: knowledge/kg/santiago_kg.ttl")
    ...
    print("📍 Step 3: Query KG for PM Behaviors")
    print("-" * 80)
    ...
    print(f"✅ Found {len(results)} PM entities in KG:")
    for r in results:
    ...
    print("📍 Step 4: Demonstrate Bootstrap Capability")
    print("-" * 80)
    print("Santiago can now:")
    print("   1. ✅ Extract PM knowledge from its own documentation")
    print("   2. ✅ Store knowledge in persistent KG (RDFLib)")
    print("   3. ✅ Generate BDD tests for PM behaviors")
    print("   4. ✅ Create MCP manifest with 20 PM tools")
    print("   5. ✅ Query its own knowledge to scaffold new capabilities")
    print()
    
    # Step 5: Show Self-Management Examples
    print("📍 Step 5: Self-Management Use Cases")
    print("-" * 80)
    ...
    print("   Result: '95% pass rate - Quality gate MET ✅'")
    print()
    
    # Step 6: Expedition Metrics
    print("📍 Step 6: Santiago-PM Expedition Metrics")
    print("-" * 80)
    ...
    print("   ✅ Self-extraction: Processed its own PM documentation")
    print("   ✅ Self-storage: Persisted knowledge to KG")
    print("   ✅ Self-testing: Generated and validated BDD tests")
    print("   ✅ Self-deployment: Created MCP manifest with 20 tools")
    print("   ✅ Self-query: Can introspect its own knowledge")
    print("   ✅ Bootstrap loop: Uses own domain to improve itself")
    print()
