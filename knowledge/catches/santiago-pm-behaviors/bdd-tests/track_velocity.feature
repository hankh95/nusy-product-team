...
# Generated: 2025-11-17T05:26:58.315233

@journeyman @sea
Feature: track_velocity
  ...
  @happy_path
  Scenario: Successfully execute track_velocity
    Given the Santiago PM knowledge graph is initialized
    When I invoke the 'track_velocity' MCP tool
    Then the MCP tool should succeed
    Then the knowledge graph should be updated

  @edge_case
  Scenario: Handle edge cases for track_velocity
    Given the Santiago PM knowledge graph is initialized
  ...
  @error_handling
  Scenario: Handle errors for track_velocity
    Given the Santiago PM knowledge graph is initialized
