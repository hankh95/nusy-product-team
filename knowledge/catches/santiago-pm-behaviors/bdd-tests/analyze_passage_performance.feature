...
Feature: Analyze passage performance
  ...
  Scenario: Analyze passage performance with valid inputs (happy path)
    Given the user provides valid input data for analyze_passage_performance
    When the analyze_passage_performance behavior is invoked
    Then a new Passage node is created in the knowledge graph
    And the response contains the expected output fields
    And the operation completes successfully

  Scenario: Analyze passage performance with edge case inputs (edge case)
    Given the user provides minimal or optional field data for analyze_passage_performance
    When the analyze_passage_performance behavior is invoked
  ...
  Scenario: Analyze passage performance with missing required fields (error handling)
