...
Whenever you add code here, link it from a note in `notes/santiago/` and reference it in the KG so the Santiago agent can cite its own implementation history.
