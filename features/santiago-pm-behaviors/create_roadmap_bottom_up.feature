...
# Behavior: create_roadmap

@master @sea @create_roadmap
Feature: MCP Tool: create_roadmap
  ...
  Scenario: Handle edge cases for create_roadmap
    ...
    When I invoke the 'create_roadmap' MCP tool with edge case data
  ...
  Scenario: Handle errors for create_roadmap
    ...
    When I invoke the 'create_roadmap' MCP tool with invalid data
