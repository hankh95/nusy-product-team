...
# Behavior: generate_passage_diagram

@journeyman @lake @generate_passage_diagram
Feature: MCP Tool: generate_passage_diagram
  ...
  Scenario: Handle edge cases for generate_passage_diagram
    ...
    When I invoke the 'generate_passage_diagram' MCP tool with edge case data
  ...
  Scenario: Handle errors for generate_passage_diagram
    ...
    When I invoke the 'generate_passage_diagram' MCP tool with invalid data
