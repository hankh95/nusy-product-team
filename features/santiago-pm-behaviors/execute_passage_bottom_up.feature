...
# Behavior: execute_passage

@master @sea @execute_passage
Feature: MCP Tool: execute_passage
  ...
  Scenario: Handle edge cases for execute_passage
    ...
    When I invoke the 'execute_passage' MCP tool with edge case data
  ...
  Scenario: Handle errors for execute_passage
    ...
    When I invoke the 'execute_passage' MCP tool with invalid data
