...
# Behavior: run_quality_gate

@journeyman @lake @run_quality_gate
Feature: MCP Tool: run_quality_gate
  ...
  Scenario: Handle edge cases for run_quality_gate
    ...
    When I invoke the 'run_quality_gate' MCP tool with edge case data
  ...
  Scenario: Handle errors for run_quality_gate
    ...
    When I invoke the 'run_quality_gate' MCP tool with invalid data
