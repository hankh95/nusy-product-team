...
# Behavior: validate_passage

@journeyman @lake @validate_passage
Feature: MCP Tool: validate_passage
  ...
  Scenario: Handle edge cases for validate_passage
    ...
    When I invoke the 'validate_passage' MCP tool with edge case data
  ...
  Scenario: Handle errors for validate_passage
    ...
    When I invoke the 'validate_passage' MCP tool with invalid data
