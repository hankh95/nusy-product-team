...
# Behavior: create_note

@journeyman @lake @create_note
Feature: MCP Tool: create_note
  ...
  Scenario: Handle edge cases for create_note
    ...
    When I invoke the 'create_note' MCP tool with edge case data
  ...
  Scenario: Handle errors for create_note
    ...
    When I invoke the 'create_note' MCP tool with invalid data
