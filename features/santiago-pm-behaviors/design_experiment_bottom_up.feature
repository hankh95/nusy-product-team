...
# Behavior: design_experiment

@master @sea @design_experiment
Feature: MCP Tool: design_experiment
  ...
  Scenario: Handle edge cases for design_experiment
    ...
    When I invoke the 'design_experiment' MCP tool with edge case data
  ...
  Scenario: Handle errors for design_experiment
    ...
    When I invoke the 'design_experiment' MCP tool with invalid data
