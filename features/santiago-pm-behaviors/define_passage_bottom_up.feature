...
# Behavior: define_passage

@master @sea @define_passage
Feature: MCP Tool: define_passage
  ...
  Scenario: Handle edge cases for define_passage
    ...
    When I invoke the 'define_passage' MCP tool with edge case data
  ...
  Scenario: Handle errors for define_passage
    ...
    When I invoke the 'define_passage' MCP tool with invalid data
