...
@apprentice @pond @log_issue
Feature: MCP Tool: log_issue
  ...
  Scenario: Handle edge cases for log_issue
    ...
    When I invoke the 'log_issue' MCP tool with edge case data
  ...
  Scenario: Handle errors for log_issue
    ...
    When I invoke the 'log_issue' MCP tool with invalid data
