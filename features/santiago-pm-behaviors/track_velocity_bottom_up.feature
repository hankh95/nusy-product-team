...
# Behavior: track_velocity

@journeyman @sea @track_velocity
Feature: MCP Tool: track_velocity
  ...
  Scenario: Handle edge cases for track_velocity
    ...
    When I invoke the 'track_velocity' MCP tool with edge case data
  ...
  Scenario: Handle errors for track_velocity
    ...
    When I invoke the 'track_velocity' MCP tool with invalid data
