...
# Behavior: create_feature

@journeyman @lake @create_feature
Feature: MCP Tool: create_feature
  ...
  Scenario: Handle edge cases for create_feature
    ...
    When I invoke the 'create_feature' MCP tool with edge case data
  ...
  Scenario: Handle errors for create_feature
    ...
    When I invoke the 'create_feature' MCP tool with invalid data
